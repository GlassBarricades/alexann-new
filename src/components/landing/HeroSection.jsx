  ...
  return (
    <div className={classes.hero}>
      ...
      <Container className={classes.container}>
        <Title className={classes.title}>Магазин напольных покрытий АлексАнн</Title>
        <Text className={classes.description} size="xl" mt="xl">
        Нас не рекламируют, нас рекомендуют друзьям!
        </Text>

        <Button component={Link} to={"/catalog"} variant="gradient" size="xl" radius="sm" className={classes.control}>
          Каталог
        </Button>
      </Container>
    </div>
